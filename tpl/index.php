    ...
    <section class="home py-5" id="home">
            ...
            <div class="row align-items-center align-content-center">
                <div class="col-md-12 mt-4 mt-md-0">
                    <div class="home-img text-center bg-secondary py-4">
                        <img src="./assets/img/profile.jpg" width="250px" height="250px"
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <img height="250px" src="./images/<?= $post->post_img?>" class="card-img-top" alt="...">
                            <div class="card-body">
                                ...
                                <a href="./post.php?post_id=<?=$post->post_id?>" target="_blank" type="button"
                                    class="btn btn-outline-secondary btn-block">ادامه مطلب</a>
                            </div>
                            <div class="card-footer">
                                <small class="text-muted">نویسنده مطلب :
                                    <?= $post->post_author?>
                                </small>
        ...
        <nav aria-label="Page navigation example" class="center">
            ...
            <?php for($x = 1; $x<=$pages; $x++):  ?>
                <li class="page-item <?= $page ===$x ?'active' :'' ?>"><a class="page-link" href="?page=<?php echo $x; ?>"><?php echo $x;?></a></li>
            <?php endfor;  ?>
            </ul>
        </nav>
